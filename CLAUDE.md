...
**Relational:** restrict, where, project, allbut, extend, rename, union, minus, intersect, matching, not_matching, join, left_join, image, summarize, group, ungroup, wrap, unwrap, transform
