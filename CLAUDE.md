...
**Relational:** restrict, where, exclude, project, allbut, extend, rename, prefix, constants, union, minus, intersect, matching, not_matching, join, left_join, image, summarize, group, ungroup, wrap, unwrap, transform
