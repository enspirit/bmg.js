...
**Totals:** 19 source files · 89 cases · 89 ported (~4 divergent, 0 known-bug), 0 blocked.
...
| [restrict.md](./restrict.md) | 11 | 11 | full (pushed down, with set-op push-down) | 10 ported; .11 still divergent (missing aggressive contradiction folding). |
